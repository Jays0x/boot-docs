...
import RemoveTemplateCommandPage from "@/components/template/Remove";

export default function Page() {
    // Sidebar sections for the remove template Command (boot remove-template <name>) page 
const pageSections = [
  "Overview",
  "Command Syntax",
  "Example Use Cases",
